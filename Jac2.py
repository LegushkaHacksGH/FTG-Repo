...
class JacquesgribMod(loader.Module):
	...
	strings = {
		'name': 'Жак с грибом',
		'usage': '.jac2 <текст/реплай на сообщение с текстом',
	}
	def __init__(self):
	...
	async def jac2cmd(self, message):
		""".jac2 <реплай на сообщение/свой текст>"""
		...
		await message.edit("<b>Жаконизируем...</b>")
		pic = requests.get("https://raw.githubusercontent.com/LegushkaHacksGH/FTG-Stuff/main/Jac2.jpg")
